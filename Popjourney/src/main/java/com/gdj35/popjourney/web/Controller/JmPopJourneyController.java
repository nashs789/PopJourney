...
public class JmPopJourneyController {
	...
	public String CJMLogins(HttpSession session, @RequestParam HashMap<String, String> params) throws Throwable {
		...
		HashMap<String, String> loginInfo = iJmPopjourneyService.login(params);
		try {
			if (loginInfo != null) {
				...
				if (lastDate.compareTo(today) < 0) {
					iJmPopjourneyService.accCnt(params);
				}
				...
				HashMap<String, String> data = iJmPopjourneyService.getNumber(params);
